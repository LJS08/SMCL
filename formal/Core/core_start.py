...
def core_start_IN(java_path, mc_path, launcher_name, username, uuid_val, aT, launcher_name_version,G1NewSizePercent_size = "20", G1ReservePercent_size = "20", Xmn="128m", Xmx="1024M", cph = None):#java_path以后可以升个级作判断，自己检测Java
	"""
