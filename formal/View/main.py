...
def main_page(base_img_src):
    ...
    # init
    window = tk.Tk()
    bgimage1 = tk.PhotoImage(file=(os.path.join(base_img_src, "image", "backdrop.png")))
    bg = tk.Label(window, image=bgimage1)
    window.iconphoto(False, tk.PhotoImage(file=(os.path.join(base_img_src, "image", "icon.png"))))
    ...
    # buttons
    img1 = tk.PhotoImage(file=(os.path.join(base_img_src, "image", "launch.png")))
    ...
    img2 = tk.PhotoImage(file=(os.path.join(base_img_src, "image", "Download.png")))
    ...
    img3 = tk.PhotoImage(file=(os.path.join(base_img_src, "image", "Settings.png")))
